...
export const SETTINGS_BASE_DEFAULTS = {
  ...
  theporndb_endpoint: 'https://theporndb.net/graphql',
...
export function getLocalizedSettingsDefaults(t = null) {
  if (!t) {
    return {
      ...
      folder_series_name: SETTINGS_BASE_DEFAULTS.folder_series_name,
  ...
  return {
    ...
    folder_series_name: t('settingsPage.sections.folderStructure.defaultSeriesName'),
...
export function getInitialFormValues(settingsData = null, t = null) {
  ...
  return {
    ...
    theporndb_api_key: getStringValue(settingsData.theporndb_api_key, defaults.theporndb_api_key),
    ...
    theporndb_endpoint: getStringValue(settingsData.theporndb_endpoint, defaults.theporndb_endpoint),
    ...
    folder_series_name: getStringValue(settingsData.folder_series_name, defaults.folder_series_name),
